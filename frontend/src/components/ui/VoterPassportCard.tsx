...
import { RitualScroll } from './RitualScroll'
          ...
          <div className="space-y-4 w-full">
            ...
            <div className="flex justify-between items-end border-t border-white/5 pt-2">
              ...
              <button
                ...
                className="text-[9px] font-cinzel text-gold hover:text-white uppercase tracking-widest border border-gold/20 bg-gold/5 px-3 py-2 rounded transition-all"
              >
                Download Scroll
              </button>
            </div>
